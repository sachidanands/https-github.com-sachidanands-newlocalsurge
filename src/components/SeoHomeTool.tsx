...
export default function SeoHomeTool({ onOpenOnboarding, hideTitle = false }: SeoHomeToolProps) {
  ...
  return (
    <div id="free-seo-tool-home" className="w-full bg-[#faf9f6]/95 rounded-3xl border border-[#dfded4] p-6 sm:p-10 text-center space-y-8 max-w-4xl mx-auto shadow-sm">
      ...
      <div className="bg-white border border-[#dfded4] rounded-2xl p-5 sm:p-6 shadow-xs max-w-3xl mx-auto">
        <form onSubmit={runAnalysis} className="flex flex-col sm:flex-row gap-3.5 items-center w-full">
          <div className="relative flex-1 w-full">
            <input
              ...
              className="bg-[#faf9f6]/95 border border-[#dfded4] rounded-xl w-full px-4 py-3 text-xs sm:text-sm text-[#1a1c1a] placeholder-[#888b88] focus:outline-none focus:border-[#123e35] transition-colors font-semibold"
            />
          </div>
          <button
            type="submit"
