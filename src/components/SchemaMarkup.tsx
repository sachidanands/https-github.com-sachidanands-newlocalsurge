...
import { CORE_LOCAL_SEO_FAQS } from './FaqSection';
...
export default function SchemaMarkup({
  ...
  // Dynamic FAQ Page Schema for Pricing & Local SEO pages based on AnswerThePublic search intent
  const getCoreLocalSeoFAQSchema = () => {
    return {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
      'mainEntity': CORE_LOCAL_SEO_FAQS.map(faq => ({
        '@type': 'Question',
        'name': faq.question,
        'acceptedAnswer': {
          '@type': 'Answer',
  ...
  const getActiveSchemas = () => {
    ...
    if (currentPage === 'pricing') {
      ...
      schemas.push(getCoreLocalSeoFAQSchema());
    }
